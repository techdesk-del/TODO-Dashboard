...
export default function TaskCard({ 
  ...
  return (
    <div 
      ...
      } ${isCompleted ? 'opacity-70 bg-slate-50/60' : 'bg-white'} ${
        deadlineInfo?.type === 'overdue' ? 'ring-1 ring-rose-400 shadow-rose-100/50' : ''
      }`}
    >
      {/* Top Header Row */}
      ...
      <div className="flex items-start gap-2 pt-0.5">
        ...
        <div className="flex-1 min-w-0">
          ...
          <h4 className={`text-[12.5px] font-semibold tracking-tight leading-snug break-words ${
            isCompleted ? 'text-slate-400 line-through' : 'text-slate-900 group-hover:text-indigo-950 transition-colors'
          }`}>
            {task.title}
          </h4>
      ...
      <div className="mt-auto pt-2.5 border-t border-slate-100 flex items-center justify-between gap-2 h-7">
        ...
        <div className="relative inline-block">
          <select
            ...
            className={`h-6 text-[10px] font-bold pl-2 pr-5 py-0.5 rounded-lg border appearance-none cursor-pointer focus:outline-none focus:ring-1 transition-all ${
