...
const initialTeamMembers = [
  { id: 'usr_shyamsundar', name: 'Shyamsundar Varma', email: 'shyamsundar@company.io', avatar: 'SV', color: '#f59e0b', role: 'ceo', pin: '1234', status: 'offline', last_heartbeat: new Date(0) },
  { id: 'usr_aakash', name: 'Aakash Das', email: 'aakash.das@company.io', avatar: 'AD', color: '#6366f1', role: 'admin', pin: '1234', status: 'offline', last_heartbeat: new Date(0) },
  { id: 'usr_yudhister', name: 'Yudhister Tiwari', email: 'yudhister.t@company.io', avatar: 'YT', color: '#10b981', role: 'member', pin: '1234', status: 'offline', last_heartbeat: new Date(0) },
  { id: 'usr_rekha', name: 'Dr Rekha Pareek', email: 'rekha.pareek@company.io', avatar: 'RP', color: '#a855f7', role: 'member', pin: '1234', status: 'offline', last_heartbeat: new Date(0) },
  { id: 'usr_sanjay', name: 'Sanjay', email: 'sanjay@company.io', avatar: 'SJ', color: '#06b6d4', role: 'member', pin: '1234', status: 'offline', last_heartbeat: new Date(0) },
  { id: 'usr_ayaz', name: 'Ayaz', email: 'ayaz@company.io', avatar: 'AY', color: '#ec4899', role: 'member', pin: '1234', status: 'offline', last_heartbeat: new Date(0) },
  { id: 'usr_utkarsh', name: 'Utkarsh', email: 'utkarsh@company.io', avatar: 'UT', color: '#3b82f6', role: 'member', pin: '1234', status: 'offline', last_heartbeat: new Date(0) },
  { id: 'usr_pratap', name: 'Pratap', email: 'pratap@company.io', avatar: 'PR', color: '#14b8a6', role: 'member', pin: '1234', status: 'offline', last_heartbeat: new Date(0) },
  { id: 'usr_varun', name: 'Varun Mudgal', email: 'varun.mudgal@company.io', avatar: 'VM', color: '#f97316', role: 'member', pin: '1234', status: 'offline', last_heartbeat: new Date(0) }
];
...
async function connectToMongo() {
  ...
  try {
    ...
    // Ensure all 9 members exist in Atlas
